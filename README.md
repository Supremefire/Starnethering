...
[30/10, 10:40 p. m.] hola: @keyframes shine {
...
[30/10, 10:43 p. m.] hola: currentAd = (currentAd + 1) % 3;
}
...
function triggerJumpscare() {
  ...
  // Play scream sound
  const scream = new Audio('https://www.myinstants.com/media/sounds/horror-scream-sound-effect.mp3');
  scream.play();
